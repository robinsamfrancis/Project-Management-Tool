        ...
        <PopoverTrigger asChild>
          {currentParent ? (
            <button
              ...
              disabled={disabled}
              className={cn(
                "group/picker relative inline-flex shrink-0 items-center justify-between gap-1 px-1.5 py-0.5 rounded text-[10px] font-bold border transition-all leading-none font-semibold",
                !disabled ? "cursor-pointer" : "cursor-default opacity-80",
            ...
            <div
              className={cn("flex items-center gap-1.5", disabled && "hidden")}
            >
              <button
                data-no-open="true"
                className={cn(
        ...
        <PopoverTrigger asChild>
          {item.dueDate ? (
            <button
              ...
              disabled={disabled}
              className={cn(
                "group/date-picker relative inline-flex items-center transition-all",
