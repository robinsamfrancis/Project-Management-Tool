...
function LoginPage() {
  ...
  const handleMicrosoftLogin = () => {
    setLoading(true);
    const role = localStorage.getItem("demo-role") || "Project Member";
    // Mock auth flow — replace with real Microsoft Entra ID later.
    setTimeout(() => {
      let name = "Project Member";
      let email = "sophia.chen@beinex.com";

      if (role === "Admin User") {
        name = "Admin User";
        email = "diego.hernandez@beinex.com";
      } else if (role === "Portfolio Manager") {
        name = "Portfolio Manager";
        email = "alex.morgan@beinex.com";
      } else if (role === "Project Manager") {
        name = "Project Manager";
        email = "priya.sign@beinex.com";
            ...
            <div className="glass rounded-3xl p-8 shadow-glass sm:p-10">
              ...
              <div className="mb-6 space-y-3">
                ...
                <select
                  ...
                  defaultValue={
                    localStorage.getItem("demo-role") || "Project Member"
                  }
                >
